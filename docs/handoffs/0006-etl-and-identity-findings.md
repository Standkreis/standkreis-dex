...
| Email provider | **Owner's call, 2026-09-05: Resend**, EU region, built in M7b once the domain exists | Transactional only, tiny volume, first-class Next.js support, free tier covers the first year. Postmark was the deliverability alternative, Scaleway and Brevo the EU-only ones, SES the cheapest and the most work |
