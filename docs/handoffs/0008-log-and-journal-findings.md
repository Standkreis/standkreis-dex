...
| C10 | ✅ | `b-journal-{de,en}-{light,dark}.png`, `b-journal-de-light-360.png`, `b-journal-empty-de-light.png` ("Noch keine Sichtung. Tipp auf ＋, wenn du etwas siehst.", no pills); `b-sighting-{de,en}-{light,dark}.png` (full), `b-sighting-de-light-360.png`. Parity test green, 19 + 28 keys per language. No XP anywhere |
